    ...
    Q: ResourceQuantity,
{
    ...
    pub(in crate::encode) fn record_violation(
        &mut self,
    ...
    #[must_use]
    #[inline(always)]
    pub(in crate::encode) fn take_violation(
        &mut self,
    ...
    pub(in crate::encode) fn record_syntax_error(
        &mut self,
    ...
    #[must_use]
    #[inline(always)]
    pub(in crate::encode) fn take_syntax_error(
        &mut self,
    ) -> Option<JsonSyntaxError> {
