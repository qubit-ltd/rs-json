...
// =============================================================================
//! Defines the stable error categories returned by the lenient decoder.
...
impl fmt::Display for NormalizingJsonDecodeErrorKind {
...
impl FromStr for NormalizingJsonDecodeErrorKind {
    type Err = &'static str;
