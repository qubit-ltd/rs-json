...
/// Configuration switches for [`crate::decode::NormalizingJsonDecoder`].
///
...
impl NormalizingJsonDecodeOptions {
    ...
    #[inline]
    #[must_use]
    pub const fn builder() -> NormalizingJsonDecodeOptionsBuilder {
        NormalizingJsonDecodeOptionsBuilder::new()
    }
...
impl NormalizingJsonDecodeOptionsBuilder {
    /// Creates a builder initialized with the default lenient options.
    #[inline]
    #[must_use]
    pub const fn new() -> Self {
        Self {
            options: NormalizingJsonDecodeOptions::lenient(),
        }
    }
    ...
    pub const fn diagnostic_policy(mut self, policy: DiagnosticPolicy) -> Self {
        self.options.diagnostic_policy = policy;
        self
    }
    ...
    #[inline]
    #[must_use]
    pub const fn build(self) -> NormalizingJsonDecodeOptions {
        self.options
    }
}

impl Default for NormalizingJsonDecodeOptionsBuilder {
    /// Creates a builder initialized with the default lenient options.
    #[inline]
    fn default() -> Self {
        Self::new()
...
impl Default for NormalizingJsonDecodeOptions {
    /// Creates the default lenient option set.
    ///
    /// # Returns
    ///
