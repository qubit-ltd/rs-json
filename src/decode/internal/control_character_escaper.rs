...
// =============================================================================
//! Defines the private raw-control-character escaper for lenient decoding.
...
impl ControlCharacterEscaper {
    ...
    fn rewrite<'a>(input: &'a str, capacity: usize) -> Cow<'a, str> {
        ...
        let mut output = output.expect("control-character rewrite requires a scanned replacement");
